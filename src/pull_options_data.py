...
def sql_query(secid=108105, year=1996, start="1996-01-01", end="2012-01-31"):
    """
    Generate SQL query for OptionMetrics data.
    ...
    year : int, optional
        Year of data to query, defaults to 1996.
    start : str, optional
    ...
    # TODO: COMPLETE THIS FUNCTION FOR THE HWK The SQL query should pull the
    # following columns: secid, optionid, date, exdate, last_date, cp_flag,
    # strike_price, best_bid, best_offer, volume, impl_volatility, delta, gamma,
    # theta, vega, contract_size, amsettlement, forwardprice, expiration The SQL
    # query should pull data from the following tables: optionm_all.opprcd{year}
    # and optionm_all.fwdprd{year} The SQL query should join the two tables on
    # the following columns: secid, date, exdate The SQL query should filter the
